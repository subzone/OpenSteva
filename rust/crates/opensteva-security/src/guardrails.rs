...
use opensteva_core::error::OpenStevaError;
use opensteva_core::{EventBus, EventType, GenerateResult, Message};
use opensteva_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(OpenStevaError::Security(
                    opensteva_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, OpenStevaError::Security(_)));
    }
}
