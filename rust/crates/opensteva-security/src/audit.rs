...
use opensteva_core::OpenStevaError;
...
impl AuditLogger {
    ...
    pub fn log(&self, event: &SecurityEvent) -> Result<(), OpenStevaError> {
    ...
    pub fn verify_chain(&self) -> Result<(bool, Option<i64>), OpenStevaError> {
        let mut stmt = self
            .conn
            .prepare(
    ...
    pub fn query(
        ...
        since: Option<f64>,
        limit: usize,
    ) -> Result<Vec<SecurityEvent>, OpenStevaError> {
