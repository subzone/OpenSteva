...
use opensteva_core::config::JarvisConfig;
...
pub fn get_engine_static(
...
) -> Result<crate::engine_enum::Engine, OpenStevaError> {
    ...
    match key.as_str() {
        ...
        other => Err(OpenStevaError::Engine(
            opensteva_core::error::EngineError::ModelNotFound(format!(
