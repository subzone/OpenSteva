...
use opensteva_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, opensteva_core::OpenStevaError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, opensteva_core::OpenStevaError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, opensteva_core::OpenStevaError>;

    fn list_models(&self) -> Result<Vec<String>, opensteva_core::OpenStevaError>;
...
mod tests {
    use super::*;
    use opensteva_core::{Message, ToolCall};
