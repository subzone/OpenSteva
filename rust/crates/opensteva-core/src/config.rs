...
//!
//! Rust translation of `src/opensteva/core/config.py`.
...
/// Default config directory: `~/.opensteva/`
pub fn default_config_dir() -> PathBuf {
    dirs_home().join(".opensteva")
}

/// Default config file path: `~/.opensteva/config.toml`
...
fn default_sandbox_image() -> String { "opensteva-sandbox:latest".into() }
...
fn default_operators_dir() -> String { "~/.opensteva/operators".into() }
