...
use opensteva_core::{OpenStevaError, ToolResult, ToolSpec};
use opensteva_security::ssrf::check_ssrf;
...
impl BaseTool for HttpRequestTool {
    ...
    fn execute(&self, params: &Value) -> Result<ToolResult, OpenStevaError> {
