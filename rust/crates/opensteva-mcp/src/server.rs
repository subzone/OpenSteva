...
mod tests {
    use super::*;
    use opensteva_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(opensteva_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
