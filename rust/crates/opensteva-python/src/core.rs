...
impl PyMessage {
    pub fn to_core(&self) -> opensteva_core::Message {
        let role = match self.role.as_str() {
            "system" => opensteva_core::Role::System,
            "assistant" => opensteva_core::Role::Assistant,
            "tool" => opensteva_core::Role::Tool,
            _ => opensteva_core::Role::User,
        };
        opensteva_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: opensteva_core::JarvisConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: opensteva_core::JarvisConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<opensteva_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(opensteva_core::EventBus::new(true)),
        }
    }
