...
Route queries to the cheapest capable model using OpenSteva's learning/routing
...
The script uses OpenSteva's routing infrastructure from the learning pillar:
