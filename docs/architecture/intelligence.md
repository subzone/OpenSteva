...
```python
from opensteva.intelligence import merge_discovered_models
...
The following names are still importable from `opensteva.intelligence` via shim modules, but their canonical locations have moved:
