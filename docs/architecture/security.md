...
The default path is `~/.opensteva/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/opensteva/security/index.md) — complete class and function signatures
