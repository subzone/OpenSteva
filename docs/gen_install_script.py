...
Serves the installers at::
    ...
    https://subzone.github.io/OpenSteva/install.sh   (Linux / macOS / WSL2)
    https://subzone.github.io/OpenSteva/install.ps1  (native Windows)

so users have an HTTPS-valid, project-controlled install URL that does not
depend on the externally-hosted ``opensteva.ai`` domain — whose TLS config
