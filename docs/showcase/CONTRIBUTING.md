...
description: How to add your setup to the OpenSteva Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether OpenSteva is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/subzone/OpenSteva/tree/main/src/opensteva/recipes/data)** if you want the exact config.
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the OpenSteva Discord](https://discord.gg/opensteva). You'll get tagged in the post — you don't have to do it yourself.
