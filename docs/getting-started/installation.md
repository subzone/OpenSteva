---
title: Installation
description: Get OpenSteva running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
OpenSteva runs entirely on your hardware. Choose the interface that fits your workflow.
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/opensteva-python/Cargo.toml
...
The desktop app is a native window for the OpenSteva chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **OpenSteva.dmg**](https://github.com/subzone/OpenSteva/releases/download/desktop-v1.0.2/OpenSteva_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **OpenSteva-setup.exe**](https://github.com/subzone/OpenSteva/releases/download/desktop-v1.0.2/OpenSteva_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **OpenSteva.deb**](https://github.com/subzone/OpenSteva/releases/download/desktop-v1.0.2/OpenSteva_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **OpenSteva.rpm**](https://github.com/subzone/OpenSteva/releases/download/desktop-v1.0.2/OpenSteva-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **OpenSteva.AppImage**](https://github.com/subzone/OpenSteva/releases/download/desktop-v1.0.2/OpenSteva_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/OpenSteva.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/subzone/OpenSteva/releases) page.

### Build from source

```bash
git clone https://github.com/subzone/OpenSteva.git
cd OpenSteva/desktop
npm install
npm run tauri build
```
...
The command-line interface is the fastest way to interact with OpenSteva
...
OpenSteva uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — OpenSteva communicates over HTTP. You still need the engine software running on your machine.
...
OpenSteva requires at least one inference backend. Choose the one that matches your hardware.
