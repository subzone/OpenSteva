...
def test_connect_slack_bot_token_returns_400(app, tmp_path: Path) -> None:
    ...
    from opensteva.server.connectors_router import _instances
...
def test_connect_granola_invalid_key_returns_400_keeps_existing(
    ...
    from opensteva.connectors.granola import GranolaConnector, GranolaKeyError
    from opensteva.server.connectors_router import _instances
    ...
    try:
        with patch(
            "opensteva.connectors.granola._granola_api_validate_key",
