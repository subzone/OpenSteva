...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("opensteva.mcp.transport.StreamableHTTPTransport"),
        patch("opensteva.mcp.client.MCPClient"),
        patch("opensteva.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):
