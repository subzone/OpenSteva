...
class TestDetectHardware:
    ...
    @patch("opensteva.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "opensteva.core.config._run_cmd",
    ...
    @patch("opensteva.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "opensteva.core.config._run_cmd",
        side_effect=[
    ...
    @patch("opensteva.core.config.platform.system", return_value="Darwin")
    @patch(
        "opensteva.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("opensteva.core.config.shutil.which", return_value=None)
    @patch("opensteva.core.config.platform.system", return_value="Linux")
