...
from opensteva.bench.energy import EnergyBenchmark
from opensteva.core.registry import BenchmarkRegistry
from opensteva.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from opensteva.bench.energy import ensure_registered
