...
from opensteva.cli.chat_cmd import _read_input, chat
...
class TestChatAgents:
    def test_simple_agent_does_not_receive_tool_only_kwargs(self) -> None:
        ...
        with (
            patch("opensteva.cli.chat_cmd.load_config", return_value=config),
            patch("opensteva.engine.get_engine", return_value=("mock", engine)),
            patch("opensteva.intelligence.register_builtin_models"),
        ):
