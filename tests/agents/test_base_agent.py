...
from opensteva.core.types import Conversation, Message, Role, ToolCall, ToolResult
...
class TestBuildMessages:
    ...
    def test_empty_config_default_no_system_message(self, monkeypatch):
        ...
        monkeypatch.setattr("opensteva.agents._stubs.load_config", lambda: empty_cfg)
