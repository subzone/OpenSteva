...
from opensteva.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from opensteva.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from opensteva.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from opensteva.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from opensteva.sessions.compression import TieredSummaries
