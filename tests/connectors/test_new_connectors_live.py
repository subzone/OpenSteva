...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from opensteva.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from opensteva.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from opensteva.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from opensteva.connectors.google_tasks import GoogleTasksConnector
