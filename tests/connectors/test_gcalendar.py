...
def connector(tmp_path: Path):
    ...
    from opensteva.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "opensteva.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("opensteva.connectors.gcalendar._gcal_api_calendars_list")
@patch("opensteva.connectors.gcalendar._gcal_api_events_list")
