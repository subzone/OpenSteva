...
def test_hackernews_registered():
    ...
    from opensteva.connectors.hackernews import HackerNewsConnector
...
def test_sync_yields_top_five(connector):
    ...
    with (
        patch(
            "opensteva.connectors.hackernews._hn_top_story_ids",
            return_value=_TOP_STORY_IDS,
        ),
        patch(
            "opensteva.connectors.hackernews._hn_item",
