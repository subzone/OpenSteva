...
def connector(tmp_path: Path):
    ...
    from opensteva.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("opensteva.connectors.dropbox._dropbox_api_list_folder")
@patch("opensteva.connectors.dropbox._dropbox_api_download")
