...
def connector(tmp_path: Path):
    ...
    from opensteva.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("opensteva.connectors.gdrive._gdrive_api_list_files")
@patch("opensteva.connectors.gdrive._gdrive_api_export")
