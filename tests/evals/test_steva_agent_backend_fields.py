...
class TestJarvisAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        from opensteva.evals.backends.jarvis_agent import JarvisAgentBackend

        with patch("opensteva.system.SystemBuilder") as MockSB:
            ...
            assert result["framework"] == "opensteva"
