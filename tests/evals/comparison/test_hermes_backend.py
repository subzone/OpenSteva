"""Tests for opensteva.evals.backends.external.hermes_agent.HermesBackend."""
...
class TestHermesBackend:
    def test_generate_full_builds_correct_subprocess_command(
        ...
        with (
            ...
            patch(
                "opensteva.evals.backends.external.hermes_agent.verify_commit_pin",
            ),
            patch(
                "opensteva.evals.backends.external.hermes_agent.run_one_shot",
            ) as mock_run,
        ):
