...
from opensteva.evals.core.event_recorder import AgentEvent, EventType
from opensteva.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from opensteva.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """OpenSteva tool names are mapped to PinchBench-expected names."""
    from opensteva.evals.scorers.pinchbench import events_to_transcript
