...
const OPTIN_KEY = 'opensteva-desktop-optin';
const OPTIN_NAME_KEY = 'opensteva-desktop-display-name';
const OPTIN_EMAIL_KEY = 'opensteva-desktop-email';
const OPTIN_ANONID_KEY = 'opensteva-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://subzone.github.io/OpenSteva/leaderboard"
            target="_blank"
