...
const CLOUD_PROVIDERS: CloudProvider[] = [
  {
    ...
    storageKey: 'opensteva-openai-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opensteva-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opensteva-gemini-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opensteva-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to OpenSteva servers</span>
          )}
        </div>
      </div>
    </div>
