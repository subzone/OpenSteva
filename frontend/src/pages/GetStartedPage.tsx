...
const GITHUB_BASE =
  'https://github.com/subzone/OpenSteva/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/subzone/OpenSteva.git\ncd OpenSteva\nuv sync"} />
          <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
            Then get started:
          </p>
          <CodeBlock code={"steva init\nsteva doctor\nsteva chat"} />
        </Section>
