...
Provides transcript translation (OpenSteva events → PinchBench format),
...
from opensteva.evals.core.event_recorder import EventType
from opensteva.evals.core.scorer import LLMJudgeScorer
from opensteva.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: OpenSteva name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from StevaAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
