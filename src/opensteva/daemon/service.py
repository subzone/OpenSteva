...
SYSTEMD_TEMPLATE = """\
[Unit]
Description=OpenSteva Gateway Daemon
After=network.target

[Service]
Type=simple
ExecStart={python} -m opensteva.daemon.gateway
Restart=on-failure
RestartSec=5
...
<dict>
    <key>Label</key>
    <string>com.opensteva.gateway</string>
    <key>ProgramArguments</key>
    <array>
        <string>{python}</string>
        <string>-m</string>
        <string>opensteva.daemon.gateway</string>
    </array>
    <key>RunAtLoad</key>
    <true/>
    <key>KeepAlive</key>
