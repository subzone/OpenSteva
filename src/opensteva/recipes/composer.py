...
if TYPE_CHECKING:
    from opensteva.evals.core.types import EvalSuiteConfig
    from opensteva.operators.types import OperatorManifest
    from opensteva.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("steva-agent" if has_agent else "steva-direct")
