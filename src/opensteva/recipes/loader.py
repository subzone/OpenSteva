...
Recipes are the universal composition format for OpenSteva.  Each recipe
...
_USER_RECIPES_DIR = Path.home() / ".opensteva" / "recipes"
_USER_OPERATORS_DIR = Path.home() / ".opensteva" / "operators"
...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/Steva.

        Returns a dict with only the non-None fields, keyed to match
        the SystemBuilder fluent API or Steva constructor parameters.
        """
        kwargs: Dict[str, Any] = {}
    ...
    def to_eval_suite(
        ...
        """
        from opensteva.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from opensteva.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.opensteva/recipes/`` directory
    4. User ``~/.opensteva/operators/`` directory
