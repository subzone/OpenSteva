"""ToolTranslator — translate external tool names to OpenSteva equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  OpenSteva uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → OpenSteva name
# ---------------------------------------------------------------------------
