...
from opensteva.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """OpenSteva support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "OpenSteva before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
