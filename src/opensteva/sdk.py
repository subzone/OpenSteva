"""High-level Python SDK for OpenSteva."""
...
from opensteva.system import StevaSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: StevaConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from opensteva.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from opensteva.tools.storage.chunking import ChunkConfig
...
class Steva:
    """High-level OpenSteva SDK.

    Usage::

        from opensteva import Steva
    ...
    @property
    def config(self) -> StevaConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the OpenSteva version string."""
        return opensteva.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import opensteva.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        import opensteva.agents  # noqa: F401
        from opensteva.agents._stubs import AgentContext
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from opensteva.tools.digest_collect import DigestCollectTool
            from opensteva.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from opensteva.cli.ask import _get_memory_backend
                from opensteva.tools.storage.context import (
                    ContextConfig,
                    inject_context,
                )
...
__all__ = ["Steva", "StevaSystem", "MemoryHandle", "SystemBuilder"]
