"""Global logging configuration for the OpenSteva CLI."""
...
from opensteva.security.credential_stripper import CredentialStripper
...
def setup_logging(
    ...
    """Configure the ``opensteva`` logger.
    ...
    Returns
    -------
    The configured ``opensteva`` logger.
    """
    logger = logging.getLogger("opensteva")
