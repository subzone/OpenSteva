"""Startup banner — OpenSteva wordmark + tagline."""

from __future__ import annotations

# "OpenSteva" rendered in the figlet "standard" font. Stored as plain text
...
def print_banner(quiet: bool = False) -> None:
    """Print the OpenSteva startup banner. No-op when quiet."""
    if quiet:
        return
    try:
