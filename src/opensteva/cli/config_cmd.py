"""``steva config`` — configuration inspection commands."""
...
def _show_hardware_info(console: Console, show_recommendations: bool = True) -> None:
    ...
    from opensteva.core.config import detect_hardware, recommend_engine
...
def set_config(key: str, value: str) -> None:
    """Set a configuration value (e.g. steva config set engine.ollama.host URL)."""
    import tomlkit

    from opensteva.core.config import DEFAULT_CONFIG_DIR, validate_config_key
