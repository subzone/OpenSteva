"""``steva chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from opensteva.engine import get_engine
    from opensteva.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import opensteva.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]OpenSteva Chat[/green bold]\n"
    ...
    from opensteva.cli._chat_notifications import NotificationDispatcher
