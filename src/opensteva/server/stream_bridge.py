...
from opensteva.agents._stubs import AgentContext, BaseAgent
from opensteva.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("opensteva.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from opensteva.core.types import Message as MsgType
                    from opensteva.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("opensteva.server")
                    _logger.warning(
