...
# src/opensteva/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m opensteva.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m opensteva.agents.hybrid.runner --cell ${name}"
