...
Why not just use OpenSteva's :class:`InferenceEngine` for both? Two reasons:
...
from opensteva.agents.hybrid._openai_retry import patch_openai_globally
...
class LocalCloudAgent(BaseAgent):
    ...
    def _call_openrouter(
        ...
        *,
        ...
        pass the OpenSteva-engine-style ``"openrouter/<provider>/<model>"``
        prefix (see ``src/opensteva/engine/cloud.py``) — we strip it here.
