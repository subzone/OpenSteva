...
Routes incoming :class:`~opensteva.channels._stubs.ChannelMessage` objects
...
from opensteva.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in OpenSteva:\nopensteva://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~opensteva.agents._stubs.BaseAgent`
        subclass).
    max_workers:
