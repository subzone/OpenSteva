...
def _load_persona(persona_name: str) -> str:
    ...
    search_paths = [
        Path("configs/opensteva/prompts/personas") / f"{persona_name}.md",
        Path.home() / ".opensteva" / "prompts" / "personas" / f"{persona_name}.md",
    ]
...
class MorningDigestAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._persona = kwargs.pop("persona", "steva")
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        evaluator_feedback = ""
        try:
            from opensteva.agents.digest_evaluator import DigestEvaluator
        ...
        output_dir = str(Path.home() / ".opensteva" / "digests")
        tts_call = ToolCall(
            id="digest-tts-1",
            name="text_to_speech",
