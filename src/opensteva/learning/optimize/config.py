...
from opensteva.learning.optimize.types import ObjectiveSpec
...
def load_objectives(data: Dict[str, Any]) -> List[ObjectiveSpec]:
    ...
    """
    from opensteva.learning.optimize.types import DEFAULT_OBJECTIVES
...
def load_benchmark_specs(data: Dict[str, Any]) -> List[Any]:
    ...
    """
    from opensteva.learning.optimize.trial_runner import BenchmarkSpec
