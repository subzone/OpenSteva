"""LLM-based optimizer for OpenSteva configuration tuning.

Uses a cloud LLM to propose optimal OpenSteva configs, inspired by DSPy's
...
from opensteva.core.types import Trace
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal OpenSteva configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an OpenSteva AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this OpenSteva evaluation result.")
        lines.append("")
