...
Adapted from IPW's ``environment.py``.  Uses OpenSteva's
:class:`~opensteva.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via OpenSteva ``ToolExecutor``.
