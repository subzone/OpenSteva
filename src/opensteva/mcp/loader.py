...
if TYPE_CHECKING:
    from opensteva.core.types import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from opensteva.core.config's
    ...
    # Imported lazily so that `opensteva.mcp.loader` can be imported
