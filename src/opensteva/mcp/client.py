...
from opensteva.mcp.protocol import MCPError, MCPRequest, MCPResponse
from opensteva.mcp.transport import MCPTransport
...
class MCPClient:
    ...
    def initialize(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            "capabilities": {},
            "clientInfo": {"name": "opensteva", "version": "0.1.0"},
        }
