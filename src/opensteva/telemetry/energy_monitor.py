...
def create_energy_monitor(
    ...
    try:
        from opensteva.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from opensteva.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from opensteva.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from opensteva.telemetry.energy_rapl import RaplEnergyMonitor
