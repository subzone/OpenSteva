"""StevaSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from opensteva.channels._stubs import BaseChannel
    from opensteva.learning._stubs import RouterPolicy
    ...
    from opensteva.speech._stubs import SpeechBackend
...
class StevaSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~opensteva.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from opensteva.core.types import Message
        from opensteva.sessions.session import SessionStore
    ...
    def __enter__(self) -> StevaSystem:
        return self
