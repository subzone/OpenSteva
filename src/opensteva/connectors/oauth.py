...
class OAuthProvider:
    ...
    # Filenames in ~/.opensteva/connectors/ to save tokens to
...
def get_client_credentials(
    ...
    Checks credential files in ``~/.opensteva/connectors/`` and falls
        ...
        def do_GET(self) -> None:  # noqa: N802 — required override name
            ...
            if "code" in params:
                ...
                self.wfile.write(
                    ...
                    b"<p>You can close this tab and return to OpenSteva.</p>"
                    b"</body></html>"
                )
