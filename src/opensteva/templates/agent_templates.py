...
def _user_templates_dir() -> Path:
    """Return the path to user-defined templates (~/.opensteva/templates/agents/)."""
    return Path.home() / ".opensteva" / "templates" / "agents"
...
def discover_templates(
    ...
    2. User templates at ``~/.opensteva/templates/agents/``.
