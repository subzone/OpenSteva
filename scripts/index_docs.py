#!/usr/bin/env python3
"""Index OpenSteva docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual OpenSteva docs the boilerplate that
    # crowds retrieval ("OpenSteva runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does opensteva support?",
