...
uv run maturin develop -m rust/crates/opensteva-python/Cargo.toml --quiet 2>/dev/null \
...
echo ""
echo -e "${GREEN}${BOLD}  OpenSteva is running!${NC}"
echo ""
